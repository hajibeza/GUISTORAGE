if _G.MainColor == nil then
    _G.MainColor = Color3.fromRGB(0, 92, 42)
end

if _G.SecondColor == nil then
    _G.SecondColor = Color3.fromRGB(0, 207, 94)
end

do  local ui =  game:GetService("CoreGui"):FindFirstChild("Ui Ripper")  if ui then ui:Destroy() end end
...
function Lib:Window(text)
    ...
    logo.Image = "rbxassetid://11269592005"
    ...
    function Ui:Tab(text)
        ...
        UIGradientTabb.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, _G.MainColor), ColorSequenceKeypoint.new(1.00, _G.SecondColor)}
        ...
        function Tab:Page()
            ...
            function main:Toggle2(text,default,callback)
                ...
                Tgle2.ImageColor3 = _G.MainColor
            ...
            function main:Button(text,callback)
                ...
                UIGradientBtn.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, _G.MainColor), ColorSequenceKeypoint.new(0.50, _G.SecondColor), ColorSequenceKeypoint.new(1.00, _G.MainColor)}
            ...
            function main:Line()
				...
				LineUIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 15, 15)), ColorSequenceKeypoint.new(0.16, Color3.fromRGB(0, 196, 90)), ColorSequenceKeypoint.new(0.51, _G.MainColor), ColorSequenceKeypoint.new(0.85, Color3.fromRGB(0, 196, 90)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 15, 15))}
            ...
            function main:Toggle(text,default,callback)
                ...
                Tgle.Name = "Tgle"
                Tgle.Parent = Toggle
                Tgle.BackgroundColor3 = _G.MainColor
            ...
            function main:Slider(text,min,max,set,callback)
                ...
                BarValue.BackgroundColor3 = _G.MainColor
            ...
            function main:Dropdown(text,option,set,callback)
                ...
                for i,v in pairs(option) do
                    ...
                    ItemButton.BackgroundColor3 = _G.MainColor
