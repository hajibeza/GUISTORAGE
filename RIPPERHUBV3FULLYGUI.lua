...
function library:UNIVERSE()
	...
	Desc.Text = "Blox Fruit | Normal Mode"
    ...
    function tabs:Tab(Name, icon)
        ...
        if S == false then
            ...
            ImageLabel.ImageColor3 = Color3.fromRGB(0, 194, 0)
        end
        ...
        Tab.MouseButton1Click:Connect(
            function()
                ...
                TweenService:Create(
                    TextLabel,
                    TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    {TextColor3 = Color3.fromRGB(0, 194, 0)}
                ):Play()
                TweenService:Create(
                    ImageLabel,
                    TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    {ImageColor3 = Color3.fromRGB(0, 194, 0)}
                ):Play()
                TweenService:Create(
                    ImageLabel,
                    TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        ...
        function sections:Section(Name,side)
            ...
            Line.Name = "Line"
            Line.Parent = Top_2
            Line.BackgroundColor3 = Color3.fromRGB(0, 194, 0)
            ...
            function functionitem:ButtonTog(Title, default, callback)
                ...
                if default then
                    ...
                    Button_2.BackgroundColor3 = Color3.fromRGB(0, 194, 0)
                end
                ...
                if default then
                    TweenService:Create(
                        ...
                        {
                            BackgroundColor3 = state and Color3.fromRGB(0, 194, 0) or Color3.fromRGB(33, 132, 112)
                        }
                    ):Play()
                    callback(default)
                    Tgs = default
                ...
                function b3Func:Update(state)
                    TweenService:Create(
                        ...
                        TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        {
                            BackgroundColor3 = state and Color3.fromRGB(33, 132, 112) or Color3.fromRGB(0, 194, 0)
                        }
                    ):Play()
                    callback(state)
                    Tgs = state
            ...
            function functionitem:Button(Name, callback)
                ...
                Button.BackgroundColor3 = Color3.fromRGB(0, 194, 0)
            ...
            function functionitem:Toggle(Name, default, callback)
                ...
                MainToggle_3.ImageColor3 = Color3.fromRGB(0, 194, 0)
    ...
    for i, v in next, Scroll_Items:GetChildren() do
        ...
        v:Destroy()
            ...
            function functionitem:Slider(Name, min, max, default, callback)
                ...
                SliderValueFrame1.BackgroundColor3 = Color3.fromRGB(0, 194, 0)
                ...
                SliderValueFrame2.BackgroundColor3 = Color3.fromRGB(0, 194, 0)
