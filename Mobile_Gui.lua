...
if getgenv().ThemeGUi == nil then
    getgenv().ThemeGUi = Color3.fromRGB(102, 255, 51)
end
...
function library:AddWindow(text,keybind)
    ...
    NameHub2.TextColor3 = getgenv().ThemeGUi 
    ...
    function Ui:AddTab(text)
        ...
        function uitab:AddPage()
            ...
            function main:AddSeperator(text)
                ...
                Sep1.BackgroundColor3 = getgenv().ThemeGUi 
                ...
                Sep3.BackgroundColor3 = getgenv().ThemeGUi 
            ...
            function main:AddLine()
                ...
                Line.Name = "Line"
                Line.Parent = Linee
                Line.BackgroundColor3 = getgenv().ThemeGUi 
            ...
            function main:AddButton(text,callback)
                ...
                Button.BackgroundColor3 = getgenv().ThemeGUi 
            ...
            function main:AddDropdown(text,option,callback)
                ...
                Dropdown.BackgroundColor3 = getgenv().ThemeGUi 
            ...
            function main:AddSlider(text,min,max,set,callback)
                ...
                Slider.BackgroundColor3 = getgenv().ThemeGUi 
                ...
                bar1.Name = "bar1"
                bar1.Parent = bar
                bar1.BackgroundColor3 = getgenv().ThemeGUi 
                ...
                slidervalue.BackgroundColor3 = getgenv().ThemeGUi 
            ...
            function main:AddTextbox(text,disappear,callback)
                ...
                Textbox.BackgroundColor3 = getgenv().ThemeGUi 
                ...
                TextboxLabel.TextColor3 = getgenv().ThemeGUi 
            ...
            function main:AddToggle(text,config,callback)
                ...
                Toggle.BackgroundColor3 = getgenv().ThemeGUi
                ...
                ToggleLabel.TextColor3 = getgenv().ThemeGUi
